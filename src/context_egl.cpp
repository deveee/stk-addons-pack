...
bool ContextManagerEGL::init(const ContextEGLParams& params)
{
    ...
    if (!success)
    {
        printf("Error: Could not initialize EGL extensions.\n");
        close();
        return false;
    }
    ...
    if (!success)
    {
        printf("Error: Could not initialize EGL display.\n");
        close();
        return false;
    }
    ...
    {
        printf("Error: EGL version is too old.\n");
        close();
        return false;
    }
    ...
    if (!success)
    {
        printf("Error: Couldn't get EGL config.\n");
        close();
        return false;
    }
    ...
    if (!success)
    {
        printf("Error: Couldn't create EGL surface.\n");
        close();
        return false;
    }
    ...
    {
        checkEGLError();
        printf("Error: Couldn't make context current for EGL display.\n");
        close();
        return false;
    }
...
void ContextManagerEGL::reloadEGLSurface(void* window)
{
    ...
    if (!m_egl_window)
    {
        printf("Error: Invalid EGL window.\n");
    }
#endif
...
bool ContextManagerEGL::checkEGLError()
{
    ...
    switch (eglGetError())
    {
        ...
        case EGL_NOT_INITIALIZED:
            printf("Error: EGL_NOT_INITIALIZED\n");
            break;
        case EGL_BAD_ACCESS:
            printf("Error: EGL_BAD_ACCESS\n");
            break;
        case EGL_BAD_ALLOC:
            printf("Error: EGL_BAD_ALLOC\n");
            break;
        case EGL_BAD_ATTRIBUTE:
            printf("Error: EGL_BAD_ATTRIBUTE\n");
            break;
        case EGL_BAD_CONTEXT:
            printf("Error: EGL_BAD_CONTEXT\n");
            break;
        case EGL_BAD_CONFIG:
            printf("Error: EGL_BAD_CONFIG\n");
            break;
        case EGL_BAD_CURRENT_SURFACE:
            printf("Error: EGL_BAD_CURRENT_SURFACE\n");
            break;
        case EGL_BAD_DISPLAY:
            printf("Error: EGL_BAD_DISPLAY\n");
            break;
        case EGL_BAD_SURFACE:
            printf("Error: EGL_BAD_SURFACE\n");
            break;
        case EGL_BAD_MATCH:
            printf("Error: EGL_BAD_MATCH\n");
            break;
        case EGL_BAD_PARAMETER:
            printf("Error: EGL_BAD_PARAMETER\n");
            break;
        case EGL_BAD_NATIVE_PIXMAP:
            printf("Error: EGL_BAD_NATIVE_PIXMAP\n");
            break;
        case EGL_BAD_NATIVE_WINDOW:
            printf("Error: EGL_BAD_NATIVE_WINDOW\n");
            break;
        case EGL_CONTEXT_LOST:
            printf("Error: EGL_CONTEXT_LOST\n");
            break;
        default:
            printf("Error: Unknown EGL error.\n");
            break;
    };
